...
CREATE TABLE IF NOT EXISTS card_studied_datetime (
    id BIGINT PRIMARY KEY AUTO_INCREMENT NOT NULL,
    flashcard_id INTEGER NOT NULL,
    studied_datetime TIMESTAMP DEFAULT NOW() NOT NULL,
    CONSTRAINT fk_card_studied_datetime_flashcard_id FOREIGN KEY (flashcard_id) REFERENCES flashcard (id)
);
